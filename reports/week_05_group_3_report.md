...
|----------------------------|--------------------------------------------------------------|------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------|
| Inconsistent column labeling | All columns                                                 | Column names had inconsistent capitalization, spaces, %, long names, or typos           | Standardized column names: lowercase, underscores, concise, replaced % with _pct where needed   |
| Wrong data types           | `date`, numeric columns                                     | `date` was object; numeric columns had inconsistent precision                             | Converted `date` to datetime; ensured numeric columns are float/int; rounded floats to 2 decimals |
