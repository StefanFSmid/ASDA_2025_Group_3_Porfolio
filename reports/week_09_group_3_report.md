...
|------|---------------------------|---------------------------|--------------|
| Missing Values       | 'PoolQC','MiscFeature','Alley','Fence', "BsmtQual", "BsmtCond", "BsmtExposure", "BsmtFinType1",
    "BsmtFinType2", "FireplaceQu", "GarageType", "GarageFinish",
    "GarageQual", "GarageCond", "MasVnrType"                           | High no. of missing values, primarily because of the option N/A which was meaningful in the context of the feature                          | Dropped 'PoolQC','MiscFeature','Alley','Fence' because they had 80%+ values of N/A, for others N/A was replaced with None to treat the value as important.             |
|      |                           |                           |              |
|      |                           |                           |              | 
|      |                           |                           |              |
